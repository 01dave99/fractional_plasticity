...
for k2 in k2s:
	...
	with open("results/frac_defl_"+str(num_dofs_global)+"_k2_"+str(k2)+".txt", 'w') as wfile:
		wfile.write("\n"+str(ydefl))	

	if msh.comm.rank==0:
	np.savetxt("results/frac_res_"+str(num_dofs_global)+"_k2_"+str(k2)+".csv",residuals,delimiter=",")
